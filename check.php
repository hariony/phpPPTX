...
if ($isWeb) {
    $output .= '<html>';
    $output .= '<head>';
    $output .= '<title>phppptx checker</title>';
    ...
    $output .= '<span>Welcome to php<span class="color">pptx</span> checker</span>';
    $output .= '</div>';
    $output .= '</div>';
...
if (file_exists('config/phppptxconfig.ini')) {
	$output .= 'Config file: ' . "\n" . file_get_contents('config/phppptxconfig.ini');
}
