<?php
// create table styles a apply them to a new table in an existing PPTX
...
$tableStyleOptions = array(
    ...
    'lastRow' => array(
        ...
        'border' => array(
            'top' => array('color' => 'none'),
            'left' => array('color' => 'none'),
            'bottom' => array('color' => 'none'),
            'right' => array('color' => 'none'),
        ),
        'bold' => true,
        'italic' => true,
    ),
);
$pptx->createTableStyle('MyTableStyle2', $tableStyleOptions);
...
$pptx->savePptx(__DIR__ . '/example_createTableStyle_2');