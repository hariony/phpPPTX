<?php
// replace text variables (placeholders) with PptxFragments using ${} to wrap placeholders doing block type replacements
...
$pptx->savePptx(__DIR__ . '/example_replaceVariablePptxFragment_2');